    ...
    <div className="min-h-screen flex items-center justify-center w-full">
      <div className="bg-white shadow-md rounded-lg px-8 py-6 max-w-md">
        ...
        <form onSubmit={onSubmitHandler}>
          ...
          <button
            type="submit"
            className="flex items-center justify-center gap-2 mt-2 w-full py-2 px-4 rounded-md text-white bg-[#8B4513] hover:bg-[#7a3d11] cursor-pointer transition-colors"
          >
